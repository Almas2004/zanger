  ...
  const dictionaries = {
    ru: {
      ...
      home: {
        ...
        aboutTitle: "Практические решения для бизнеса и частных клиентов",
        aboutTextOne: "ZANGER CONSULTING GROUP оказывает юридическую помощь по деловым и личным вопросам. Мы внимательно изучаем обстоятельства, оцениваем риски и предлагаем реалистичную правовую позицию.",
        aboutTextTwo: "Наша задача — сделать сложный юридический процесс управляемым: от первой консультации до подготовки документов, переговоров или представления интересов.",
    ...
    kk: {
      ...
      home: {
        ...
        aboutTitle: "Бизнес пен жеке клиенттерге арналған практикалық шешімдер",
        aboutTextOne: "ZANGER CONSULTING GROUP іскерлік және жеке мәселелер бойынша заңгерлік көмек көрсетеді. Біз жағдайды мұқият зерттеп, тәуекелдерді бағалаймыз және нақты құқықтық ұстаным ұсынамыз.",
        aboutTextTwo: "Біздің міндетіміз — күрделі заң процесін басқарылатын ету: алғашқы кеңестен бастап құжаттарды дайындауға, келіссөздерге немесе мүддені қорғауға дейін.",
  ...
  const serviceTranslations = {
    kk: {
      ...
      "sudebnoe-predstavitelstvo": {
        ...
        tasks: ["Талап арыздар", "Пікірлер мен қарсылықтар", "Отырыстарға қатысу", "Орындауды сүйемелдеу"],
      ...
      "registraciya-ip-i-too": {
        ...
        description: "Нысанды таңдауға, құжаттарды дайындауға және ЖК немесе ЖШС іске қосуға көмектесу.",
